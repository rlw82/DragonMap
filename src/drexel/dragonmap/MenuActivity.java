...
public class MenuActivity extends Activity
{
	 ...
	 * 	no explicit intents that start the0 MenuActivity, initializations in the
	...
	public void initialize()
	{
        ...
        ResourceManager.setPOIs( POIs );

        ResourceManager.setMap( mapImage );
        ResourceManager.setPin( pinImage );
